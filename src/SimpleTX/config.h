...
#define ANALOG_CUTOFF 150 // cutoff lower and upper end to avoid un-symmetric joystick range in trade off resolution
...
const int analogInPinRudder   = A3; // A0;
const int analogInPinThrottle = A2; // A1;
const int analogInPinAileron  = A0; // A2;
const int analogInPinElevator = A1; // A3;
...
// simple binary 2-pos
const int DIGITAL_PIN_SWITCH_ARM  = 4;  // Arm switch (2-pos)

// simple binary 2-pos
const int DIGITAL_PIN_SWITCH_AUX2 = 5;  // beeper switch (2-pos)

// it takes 2 bits for a 3-pos switch in binary mode
const int DIGITAL_PIN_SWITCH_AUX3a = 6;  // aux3: 3-pos (set to 0 to disable this input)
const int DIGITAL_PIN_SWITCH_AUX3b = 7;  // aux3: 3-pos (set to 0 to disable this input)

// it takes 2 bits for a 3-pos switch in binary mode
const int DIGITAL_PIN_SWITCH_AUX4a = 8;  // aux4: 3-pos (set to 0 to disable this input)
const int DIGITAL_PIN_SWITCH_AUX4b = 9;  // aux4: 3-pos (set to 0 to disable this input)



// pins that used for output
const int DIGITAL_PIN_LED = 13; // use standard led pin instead of 5;  
